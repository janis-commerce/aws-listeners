		...
		sandbox.assert.calledWithExactly(SNSListenerTest.prototype.setProps, {
			_event: {
				...
				mail: {
					...
					destination: ['pablo.guzman@fizzmod.com', 'fernando.colom@fizzmod.com'],
					headersTruncated: false,
					headers: [
						{
							name: 'Received',
							value: 'from localhost.localdomain'  // eslint-disable-line
						},
						{
							name: 'Date',
					...
					commonHeaders: {
						...
						from: ['Janis QA <no-reply@janisqa.in>'],
						date: 'Tue, 4 Feb 2020 17:45:39 -0300',
						to: ['pablo.guzman@fizzmod.com'],
